...
drop policy "Allow team admins or owners to create plans" on "public"."plans";

drop policy "Allow team admins or owners to delete plans" on "public"."plans";

drop policy "Allow team admins or owners to update plans" on "public"."plans";

drop policy "Allow users to see their team's or own plans" on "public"."plans";

drop policy "Only admins can delete access records" on "public"."profile_integration_access";

drop policy "Only admins can insert access records" on "public"."profile_integration_access";

drop policy "Profiles can view their own access records" on "public"."profile_integration_access";
...
drop table "public"."profile_integration_access";
