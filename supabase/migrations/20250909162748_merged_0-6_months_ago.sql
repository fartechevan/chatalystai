-- Merged migration: 0-6_months_ago
-- Consolidates 23 migrations:
-- - 20250616081500_create_get_active_subscription_rpc.sql
-- - 20250616215800_add_image_url_to_broadcasts.sql
-- - 20250630145800_add_segment_id_to_broadcasts.sql
-- - 20250701085200_remove_owner_id_from_plans.sql
-- - 20250701143500_drop_profile_integration_access.sql
-- - 20250704212100_create_delete_agent_with_relations_function.sql
-- - 20250704213100_grant_execute_on_delete_agent_function.sql
-- - 20250721175500_link_conversations_to_integrations_config.sql
-- - 20250722112200_refactor_ai_agent_schema.sql
-- - 20250722112300_schema_from_source.sql
-- - 20250722142500_add_ended_at_to_ai_agent_sessions.sql
-- - 20250820063021_add_customer_id_to_appointments_final.sql
-- - 20250907010847_create_whatsapp_logins_table.sql
-- - 20250907035314_add_phone_number_to_profiles.sql
-- - 20250907181900_create_match_vector_function.sql
-- - 20250907185200_add_knowledge_document_ids_to_ai_agents.sql
-- - 20250907185500_drop_ai_agent_knowledge_documents_table.sql
...
-- - 20250909162742_merged_functions.sql
-- - 20250909162743_merged_schema.sql
-- Generated on: 2025-09-09T16:27:48.529Z

-- ============================================================================
-- Migration 1/23: 20250616081500_create_get_active_subscription_rpc.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 2/23: 20250616215800_add_image_url_to_broadcasts.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 3/23: 20250630145800_add_segment_id_to_broadcasts.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 4/23: 20250701085200_remove_owner_id_from_plans.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 5/23: 20250701143500_drop_profile_integration_access.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 6/23: 20250704212100_create_delete_agent_with_relations_function.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 7/23: 20250704213100_grant_execute_on_delete_agent_function.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 8/23: 20250721175500_link_conversations_to_integrations_config.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 9/23: 20250722112200_refactor_ai_agent_schema.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 10/23: 20250722112300_schema_from_source.sql
-- ============================================================================



-- ============================================================================
-- Migration 11/23: 20250722142500_add_ended_at_to_ai_agent_sessions.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 12/23: 20250820063021_add_customer_id_to_appointments_final.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 13/23: 20250907010847_create_whatsapp_logins_table.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 14/23: 20250907035314_add_phone_number_to_profiles.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 15/23: 20250907181900_create_match_vector_function.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 16/23: 20250907185200_add_knowledge_document_ids_to_ai_agents.sql
-- ============================================================================

ALTER TABLE public.ai_agents
ADD COLUMN knowledge_document_ids uuid[];


-- ============================================================================
-- Migration 17/23: 20250907185500_drop_ai_agent_knowledge_documents_table.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 18/23: 20250907190000_fix_match_knowledge_chunks_for_agent_function.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 19/23: 20250907200000_correct_match_function_return_type.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 20/23: 20250907210000_add_document_title_to_match_function.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 21/23: 20250909114041_remote_schema.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 22/23: 20250909162742_merged_functions.sql
-- ============================================================================
...
-- ============================================================================
-- Migration 23/23: 20250909162743_merged_schema.sql
-- ============================================================================
